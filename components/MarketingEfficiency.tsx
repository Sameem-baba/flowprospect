    ...
    return (
        ...
        >
            <div className="w-full md:w-1/2 bg-[#f5f6f7] bg-opacity-90 backdrop-blur-sm p-8 md:p-16">
                <h2 className="text-5xl font-bold text-gray-900 font-[electrolize] mb-6 leading-tight">
                    26% <span className="font-normal">increase in marketing efficiency</span>
                </h2>
                <p className="text-gray-700 font-[roboto] mb-8 max-w-md">
                ...
                <button className="bg-black font-[electrolize] text-white px-8 py-4 rounded-md text-lg font-semibold hover:bg-gray-800 transition mb-8">
                    See the benefits for B2C
                </button>
                <p className="text-gray-400 text-xs max-w-md font-[roboto]">
