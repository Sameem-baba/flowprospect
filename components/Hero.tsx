            ...
            <div className="relative z-10 mx-auto max-w-4xl flex flex-col items-center justify-center h-full">
                <div className="text-center">
                    ...
                    <div className="mt-10 flex items-center justify-center gap-x-6">
                        <Link
                            href="/contact"
                            className="rounded-md uppercase tracking-wider bg-[#3366CC] px-4 py-3 text-sm font-semibold text-white shadow-md hover:bg-blue-400 transition duration-300"
                        >
                            Book a call
                        </Link>
                        <button
